...
function generateATag(notification, property) {
    ...
    if (property === 'createdTime') {
        ...
        return '<a class="table-row-link" href="/notification/' + notification._id + '"><img class="img-data-row" alt="treeImg" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQbQa3ZRo97YeHzyY7kBJPtS2nQx0u5dcMjD8rm2yLphWgWE3ci&usqp=CAU"/></a>'
    }
